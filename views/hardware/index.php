        ...
        <div style="background-color:#ffffff;;width: 85%;margin-left: 110px;">
            ...
            <div class="nav" id="pagenavi">
                ...
                <div><a href="../../contact.php">Contact Us</a></div>
                    ...
                    <p><h1 style="color:#000055; background-color:#e3e3e3; padding:30px; margin-right:38px; font-size:29px; border:2px solid #c3c3c3;">Hardware Book</h1></p></br></br></br></br>
                    ...
                    <table style="background-color:#f7f7f7;">
                        <tr>
                            ...
                            <td style="width:69%; margin-top:10px; background-color:#f9f9f9;">
                                 ...
                                 * @param = Hardware books in this case
                                 */
                                views("Hardware books")
                                ?>
